...
Smartwatch Water Temperature Methodology
...
This document describes the methodology used to process smartwatch water temperature observations collected during sea swims at Whitley Bay.
...
Water temperature observations are extracted from smartwatch workout data recorded during open-water swims.

Version 0.1 of this methodology has been developed using Apple Watch data extracted from Apple Health. Future versions may support other smartwatch platforms where comparable water temperature observations are available.
...
The representative water temperature for each swim session is estimated from the stable temperature plateau observed after the device sensor has equilibrated with the surrounding seawater.
...
Smartwatch water temperature observations may be affected by several factors, including:
...
* differences between device models or software versions
